    ...
    <div className="flex flex-col-reverse lg:flex-row justify-center items-center mt-12 mb-8">
      <div id="card" className="lg:w-1/2 flex justify-center lg:mb-0 relative z-10 lg:z-1">
        <animated.img 
          src={card2} 
          alt="hero" 
          className="h-[100px] w-[300px] sm:h-[125px] sm:w-[400px] md:h-[150px] md:w-[450px] lg:h-[200px] lg:w-[500px] xl:h-[200px] xl:w-[600px] rounded-lg lg:ml-48 mt-6" 
      ...
      <div className="lg:w-1/2 flex justify-center mb-8 lg:mb-0 z-10 lg:z-1 md:mt-8 md:px-16">
        <div className="text-center lg:text-left px-4 lg:px-0">
          <h2 className="text-4xl font-bold tracking-tight text-rose-600 mb-4 sm:text-5xl font-popping text-black">¡Practica inglés de por vida!</h2>
          <p className="text-4xl font-bold tracking-tight text-rose-600 sm:text-5xl font-popping text-[#b5d3f8] mb-4">Únete a nuestra gran comunidad</p>
